...
const actionLabels: Record<AuditActionType, string> = {
  ...
  COURSE_INVITATION_ACTIVATED: "Course invitation activated",
  COURSE_INVITATION_CANCELLED: "Course invitation cancelled",
  COURSE_INVITATION_CREATED: "Course invitation created",
  COURSE_INVITATION_EXPIRED: "Course invitation expired",
  COURSE_INVITATION_FAILED: "Course invitation failed",
  COURSE_INVITATION_RESENT: "Course invitation prepared for resend",
  COURSE_INVITATION_SENT: "Course invitation sent",
