...
function buildCourseInvitationEmailContent(input: {
  ...
  return {
    html: `
      ...
      <p>You have been invited to access <strong>${courseTitle}</strong> in the CSO Learning Hub.</p>
      ...
      <p>This one-time link expires on ${expiresAt}.</p>
    ...
    text: [
      ...
      "",
      `You have been invited to access ${input.courseTitle} in the CSO Learning Hub.`,
      "Activate your account and course access using this secure personal link:",
      input.invitationUrl,
      "",
      `This one-time link expires on ${input.expiresAt.toUTCString()}.`,
